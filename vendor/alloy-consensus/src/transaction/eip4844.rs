...
#[cfg(feature = "eips-kzg-sidecar")]
use alloy_eips::eip4844::BlobTransactionSidecar;
#[cfg(feature = "eips-kzg-sidecar")]
use alloy_eips::eip7594::{BlobTransactionSidecarEip7594, BlobTransactionSidecarVariant};

/// どこで: alloy-consensus内のフォーク実装
/// 何を: kzg-sidecar非有効時のデフォルトSidecar型を定義
/// なぜ: tx復元用途ではSidecar本体を使わず、kzg-sidecar依存を分離するため
#[cfg(not(feature = "eips-kzg-sidecar"))]
#[derive(Clone, Debug, Default, PartialEq, Eq, Hash)]
pub struct NoEip4844Sidecar;

#[cfg(not(feature = "eips-kzg-sidecar"))]
impl Encodable7594 for NoEip4844Sidecar {
    fn encode_7594_len(&self) -> usize {
        0
    }

    fn encode_7594(&self, _out: &mut dyn BufMut) {}
}

#[cfg(not(feature = "eips-kzg-sidecar"))]
impl Decodable7594 for NoEip4844Sidecar {
    fn decode_7594(_buf: &mut &[u8]) -> alloy_rlp::Result<Self> {
        Err(alloy_rlp::Error::Custom("kzg-sidecar feature is disabled"))
    }
}

#[cfg(feature = "eips-kzg-sidecar")]
type DefaultEip4844Sidecar = BlobTransactionSidecarVariant;
#[cfg(not(feature = "eips-kzg-sidecar"))]
type DefaultEip4844Sidecar = NoEip4844Sidecar;
...
pub enum TxEip4844Variant<T = DefaultEip4844Sidecar> {
...
pub struct TxEip4844WithSidecar<T = DefaultEip4844Sidecar> {
