...
## 根拠
- `/Users/0xhude/Desktop/ICP/Kasane/crates/ic-evm-wrapper/src/lib.rs`（`expected_nonce_by_address`）
- `/Users/0xhude/Desktop/ICP/Kasane/crates/evm-core/src/tx_decode.rs`（`IcSynthetic` / `EthSigned`）
- `/Users/0xhude/Desktop/ICP/Kasane/crates/evm-core/src/chain.rs`（`TxIn::IcSynthetic`）
