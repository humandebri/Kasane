...
- `scripts/check_icp_query_precompile_verification.sh`: PR #81 ICP query precompile 用gate。Verus、PBT/async/allowlist/PocketIC test、Bidi制御文字検査、workspace check、対象rustfmt、PR内specgen成果物を検証する
