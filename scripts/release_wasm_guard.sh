...
cargo build --target wasm32-unknown-unknown --release -p ic-evm-gateway --locked

WASM_IN="target/wasm32-unknown-unknown/release/ic_evm_gateway.wasm"
WASM_OUT="target/wasm32-unknown-unknown/release/ic_evm_gateway.release.final.wasm"
