...
pub fn submit_transition_safe_raw(decision_code: u64, pending_slot_points_to_new: u64, new_current_written: u64, queued_loc_written: u64, replacement_old_removed: u64) -> bool
{
