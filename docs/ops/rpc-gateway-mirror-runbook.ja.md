...
English version: [./rpc-gateway-mirror-runbook.md](./rpc-gateway-mirror-runbook.md)
...
## ドキュメント言語運用
- `tools/rpc-gateway/README.md` は英語正本として運用する。
- 日本語は `README.ja.md`（および `ops/README.ja.md`, `smoke/README.ja.md`, `contracts/README.ja.md`）を補助版として同期する。
