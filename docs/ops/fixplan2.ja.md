...
English version: [./fixplan2.md](./fixplan2.md)
...
> 注記（2026-02 現在）: この節は中長期の設計案を含む。現行実装は整合性優先で storage write 失敗時に `trap` ロールバックを採用している。運用・公開仕様は `README.md` / `docs/specs/indexer-v1.md` / `docs/ops/indexer-runbook.md` を正本として参照すること。
